...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //let accountManager = DBAccountManager(appKey: apiKey, secret: apiSecret)
        //DBAccountManager.setSharedManager(accountManager)
      
        addSkipBackupAttributeToItemAtURL()
        
        let dBSession = DBSession(appKey: apiKey as String, appSecret: apiSecret as String, root: kDBRootAppFolder)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Rondogo", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Rondogo.sqlite")
    ...
    // MARK: - Skip All media from iCloud Back up
    
    func addSkipBackupAttributeToItemAtURL(){
        ...
        let URL : NSURL = NSURL.fileURLWithPath(docDirPathStr as! String)
